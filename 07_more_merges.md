...
今回は Fast-fowarding せずにマージコミットを作る方式でマージを行いましたが。このやり方よりも Fast-foward できるときは Fast-foward してしまうほうが好みであるというひともいます。このあたりは現在でも活発に宗教戦争が起こっているので、あなたの所属する組織やプロジェクトのやり方に合わせるといいでしょう。
